def assets_from_path(path, js_found, css_found, img_found):
	...
	for js_file in js_files:
		...
		js_file = js_file.attrs["src"] if "src" in js_file.attrs
	...
	for css_file in css_files:
		...
		css_file = css_file.attrs["href"] if 'rel="stylesheet"' in css_file.attrs
	...
	for img_file in img_files:
		...
		img_file = img_file.attrs["src"] if "src" in img_file.attrs
